...
class Target(metaclass=Metaclass_Target):
    ...
    def z_2(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'z_2' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'z_2' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._z_2 = value
