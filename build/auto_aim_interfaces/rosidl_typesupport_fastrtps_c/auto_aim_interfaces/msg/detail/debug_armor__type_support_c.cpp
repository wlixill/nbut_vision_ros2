...
#include "rosidl_runtime_c/string.h"  // armor_type
#include "rosidl_runtime_c/string_functions.h"  // armor_type
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->armor_type;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: armor_type
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->armor_type.data) {
      rosidl_runtime_c__String__init(&ros_message->armor_type);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->armor_type,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'armor_type'\n");
      return false;
    }
  }
