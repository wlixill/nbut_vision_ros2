...
#define NODE_MAIN_LOGGER_NAME "daheng_camera_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdaheng_camera.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<daheng_camera::AcquisitionNode>";
