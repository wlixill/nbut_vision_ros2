...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__DebugArmor__rosidl_typesupport_introspection_c__DebugArmor_message_member_array[6] = {
  {
    "center_x",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__DebugArmor, armor_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
